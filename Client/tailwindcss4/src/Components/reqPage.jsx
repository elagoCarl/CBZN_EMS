          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm sm:text-base">
            ...
            <div>
              ...
              <p className="text-white">
                {request.details.overtimeStart} - {request.details.overtimeEnd}
              </p>
            </div>
        ...
        return (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm sm:text-base">
            ...
            <div>
              ...
              <p className="text-white">
                From {request.details.timeAdjustFrom} to{" "}
                {request.details.timeAdjustTo}
              </p>
            </div>
            <div className="sm:col-span-2">
              <p className="text-xs sm:text-sm font-medium text-gray-400">
        ...
        <div className="flex flex-col gap-4 mb-4">
          ...
          <div className="flex overflow-x-auto pb-2 gap-2 hide-scrollbar">
            <button
              ...
              className={`px-3 py-1 rounded-full text-xs sm:text-sm whitespace-nowrap flex-shrink-0 ${
                activeFilter === "all"
            ...
            <button
              ...
              className={`px-3 py-1 rounded-full text-xs sm:text-sm whitespace-nowrap flex items-center gap-1 flex-shrink-0 ${
                activeFilter === "overtime"
                  ? "bg-green-600 text-white"
                  : "bg-[#363636] text-white hover:bg-[#404040]"
              }`}
            >
              <Clock className="w-3 h-3 sm:w-4 sm:h-4" /> Overtime
            </button>
            <button
            ...
            >
              <Calendar className="w-3 h-3 sm:w-4 sm:h-4" /> Leave
            </button>
            <button
              onClick={() => setActiveFilter("timeadjustment")}
              className={`px-3 py-1 rounded-full text-xs sm:text-sm whitespace-nowrap flex items-center gap-1 flex-shrink-0 ${
                activeFilter === "timeadjustment"
                  ? "bg-green-600 text-white"
                  : "bg-[#363636] text-white hover:bg-[#404040]"
              }`}
            >
              <Clock className="w-3 h-3 sm:w-4 sm:h-4" /> Time Adjustment
            </button>
            <button
            ...
            >
              <UserCheck className="w-3 h-3 sm:w-4 sm:h-4" /> Schedule Change
            </button>
          </div>
          ...
          <div className="flex justify-end">
            <button
              className="bg-green-600 text-white px-3 py-1 sm:p-2 rounded text-xs sm:text-sm hover:bg-green-700 flex items-center transition-colors"
              ...
              <table className="min-w-full divide-y divide-gray-800">
                <thead className="sticky top-0 bg-[#2b2b2b] z-10">
                  <tr>
                    ...
                    <th
                      scope="col"
                      className="px-2 sm:px-4 py-2 sm:py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider hidden sm:table-cell"
                    >
                      Date
                    </th>
                    <th
                    ...
                    <th
                      scope="col"
                      className="px-2 sm:px-4 py-2 sm:py-3 text-right text-xs font-medium text-gray-400 uppercase tracking-wider"
                    >
                      Actions
                    </th>
                  </tr>
                      ...
                      <React.Fragment key={request.id}>
                        ...
                        {expandedRow === request.id && (
                          <tr>
                            <td
                              colSpan="6"
                              className="px-3 sm:px-6 py-3 sm:py-4 bg-[#2d2d2d] border-t border-gray-800"
                            >
                              <div
                  ...
                  <React.Fragment key={index}>
                    {page === "..." ? (
                      ...
                      <button
                        ...
                        className={`px-2 sm:px-3 py-1 rounded text-xs sm:text-sm min-w-[24px] sm:min-w-[32px] ${
                          currentPage === page
                            ? "bg-green-600 text-white"
                            : "bg-[#363636] text-white hover:bg-[#404040]"
                        }`}
