...
const AddLeaveModal = ({ isOpen, onClose, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('/leaveInfo/addLeaveInfo', {
                title,
                isActive
            });
            ...
            console.error('Error adding leave info:', error);
        ...
        <div className="fixed inset-0 bg-black/20 flex items-center justify-center p-4 z-50">
            <div className="bg-[#2b2b2b] rounded-lg w-full max-w-md">
                <div className="flex justify-between items-center p-6 border-b border-white/10">
                    <h2 className="text-xl font-semibold text-white">Add Leave Info</h2>
...
const EditLeaveModal = ({ isOpen, onClose, onSuccess, leave }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`/leaveInfo//updateLeaveInfo/${leave.id}`, {
                title,
                isActive
            });
    ...
    return (
        <div className="fixed inset-0 bg-black/20 flex items-center justify-center p-4 z-50">
            <div className="bg-[#2b2b2b] rounded-lg w-full max-w-md">
                <div className="flex justify-between items-center p-6 border-b border-white/10">
                    <h2 className="text-xl font-semibold text-white">Edit Leave Info</h2>
                    <button onClick={onClose} className="text-gray-400 hover:text-white">
                        <X className="w-5 h-5" />
                    </button>
                </div>
